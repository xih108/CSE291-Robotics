...
#                 target_pose_left = Pose([-0.12, 0.65, 0.55], euler2quat(np.pi, -np.pi / 3, -np.pi / 2))
#                 self.diff_drive(robot_left, 9, target_pose_left)

#                 target_pose_right = Pose([-0.12, -0.65, 0.55], euler2quat(np.pi, -np.pi / 3, np.pi / 2))
#                 self.diff_drive(robot_right, 9, target_pose_right)
 
#             elif self.counter < 5000 / 5:
